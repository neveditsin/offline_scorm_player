/**
 * Based on SCOBot API_1484_11
 */
 
function SCOBOTAPIAdaptor12(ld, options){

	var scobot = new SCOBot_API_1484_11(ld, options);
	...
	this.LMSGetValue = function (key) {
		...
		switch (key) {
			...
			case "cmi.core.student_name":
				nn = "cmi.learner_name";
				break;
			case "cmi.student_preferences.audio":
				nn = "cmi.learner_preferences.audio_level";
				break;
			case "cmi.student_preferences.speed":
				nn = "cmi.learner_preferences.delivery_speed";
				break;
			case "cmi.student_preferences.language":
				nn = "cmi.learner_preferences.language";
				break;
			case "cmi.student_preferences.text":
				nn = "cmi.learner_preferences.audio_captioning";
				break;			
			case "cmi.core.lesson_status":
				nn = "cmi.completion_status";
				break;
		...
		return scobot.GetValue(nn);
		
	};
	this.LMSSetValue = function(n, v){
		switch (n) {
			case "cmi.comments":
				nn = "cmi.comments_from_learner.comment";
				break;
			case "cmi.core.lesson_location":
				nn = "cmi.location";
				break;
			...
			return scobot.SetValue(nn, v);
	}
	
	this.LMSCommit = scobot.Commit;
	this.LMSFinish = scobot.Terminate;
	this.LMSGetLastError = scobot.GetLastError;
	this.LMSGetErrorString = scobot.GetErrorString;
	this.LMSGetDiagnostic = scobot.GetDiagnostic;
} 

 
function SCOBot_API_1484_11(ld, options) {
    // Constructor
    "use strict";
    var Utl      = SCOBotUtil,
        defaults = {
         ...
         */
        completion_status = "|completed|incomplete|not attempted|unknown|passed|browsed|failed|",
        /**
         Read Only values -
         ...
         */
        read_only = "|_version|completion_threshold|credit|entry|learner_id|learner_name|_children|_count|mode|maximum_time_allowed|scaled_passing_score|time_limit_action|total_time|comment|",
        /**
         * Write Only values
         */
        write_only = "|exit|",
    ...
    this.Initialize = function () {
	   ...
	   Funcs.sendRq("generic",appWindow.location.pathname, "Initialize", null, cmi);
